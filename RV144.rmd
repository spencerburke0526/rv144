...
<!--Display inferential evidence as to the effectiveness of the vaccine with explanations and interpretations!-->
 We not want to run a statistical test to see if the aides vaccine was seemingly eggective. We state the null and alternative hypothesis for this test.
...
```
The p-value of  0.04 means the probability of getting a result like that just obtained if the null hypothesis is true is approximately 4 percent. This is normally considered significant.
